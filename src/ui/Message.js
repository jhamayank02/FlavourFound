...
const MessageContent = (props)=>{
    return <div className={`${props.error ? 'bg-[#e34646]' : 'bg-[#62af1d]'} flex justify-between z-20 rounded-md text-white px-3 py-1 fixed w-[60%] top-4 left-[50%] translate-x-[-50%] max-[600px]:w-[90%]`}>
        {props.children}
