  ...
  return (
    <>
      <Modal hideModal={hideEditOrderModal}>
          <h1 className='text-3xl mt-2 mb-4 text-[#484b4bf2] text-center underline'>Edit order</h1>

          <form onSubmit={formSubmitHandler} className='w-[400px] mx-auto max-[600px]:w-[90%]'>

            <label className='text-[#515454]'>Order id</label>
            <input disabled ref={orderIdRef} type="text" required className="focus:outline-1 focus:outline-[#c9c9c9] border-[1px] mb-2 py-1 px-3 rounded-sm w-[100%] bg-[#c1c0bf99] cursor-not-allowed"></input>

            <label className='text-[#515454]'>Shipping address</label>
            <input ref={shippingAddressRef} type="text" required className="focus:outline-1 focus:outline-[#c9c9c9] border-[1px] mb-2 py-1 px-3 rounded-sm w-[100%]"></input>

            <label className='text-[#515454]'>Order delivered (true/false)</label>
            <input ref={deliveredRef} type="text" required className="focus:outline-1 focus:outline-[#c9c9c9] border-[1px] mb-2 py-1 px-3 rounded-sm w-[100%]"></input>

            <div className='flex justify-end mt-2'>
              <button onClick={hideEditOrderModal} className="mt-2 mr-2 #515454 py-1 px-4 border-[1px] border-[#515454] rounded-2xl hover:bg-[#484b4bf2] hover:text-white">Close</button>
